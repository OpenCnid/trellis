...
COPY package.json package-lock.json ./
COPY src/rlm/trellis_agent.py src/rlm/trellis_tools.py src/rlm/trellis_mcp.py src/rlm/trellis_workspace.py src/rlm/trellis_modules.py src/rlm/trellis_textedit.py src/rlm/trellis_answer.py src/rlm/trec_rubric.json ./src/rlm/
